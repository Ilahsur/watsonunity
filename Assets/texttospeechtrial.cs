...
public class texttospeechtrial : MonoBehaviour {
	...
	void NewSpeech(){
		GameObject thisText = GameObject.Find ("SpeakThis");
		speakThis = thisText.GetComponent<Text>().text;
		print ("speakThis");
		m_TextToSpeech.ToSpeech(speakThis, HandleToSpeechCallback);
	}
}
